...
def _extract_letter_box_questions(
    ...
    prompt = f"""Analyze BOTH test pages from 11+ Verbal Reasoning Test {test_num}.

CRITICAL: There are exactly 10 questions (Q11-Q20) spread across BOTH images:
- Questions 11-15 are on the FIRST image (page 3)
- Questions 16-20 are on the SECOND image (page 4)
- You MUST extract ALL 10 questions from BOTH pages

Question format:
- A word is given on the LEFT
- Letter boxes on the RIGHT need to be filled to spell a word with the {meaning_type} meaning

Extract and return a JSON object with EXACTLY 10 questions:
{{
    "instruction": "The instruction text shown",
    "questions": [
        {{"question_number": 11, "given_word": "wide", "partial_answer": "n_rr_w"}},
        {{"question_number": 12, "given_word": "ancient", "partial_answer": "m_d_rn"}},
        {{"question_number": 13, "given_word": "full", "partial_answer": "e_p_y"}},
        {{"question_number": 14, "given_word": "brave", "partial_answer": "c_w_rdly"}},
        {{"question_number": 15, "given_word": "arrival", "partial_answer": "d_p_rt_re"}},
        {{"question_number": 16, "given_word": "...", "partial_answer": "..."}},
        {{"question_number": 17, "given_word": "...", "partial_answer": "..."}},
        {{"question_number": 18, "given_word": "...", "partial_answer": "..."}},
        {{"question_number": 19, "given_word": "...", "partial_answer": "..."}},
        {{"question_number": 20, "given_word": "...", "partial_answer": "..."}}
    ]
}}

IMPORTANT:
- Extract from BOTH images - do not stop at Q15
- Extract the given word exactly as shown
- Show partial letters in boxes and use _ for empty boxes
- Return ONLY valid JSON with all 10 questions"""
...
CRITICAL: There are exactly 10 questions (Q11-Q20) spread across BOTH images:
- Questions 11-15 are typically on the FIRST image (page 3)
- Questions 16-20 are typically on the SECOND image (page 4)
- You MUST extract ALL 10 questions from BOTH pages

These pages contain a LETTER-WORD MATCHING or SENTENCE REARRANGEMENT exercise.

Extract and return a JSON object with EXACTLY 10 questions:
{{
    "instruction": "The instruction text shown",
    "questions": [
        {{"question_number": 11, "description": "word or sentence content", "options": ["opt1", "opt2", "opt3"]}},
        {{"question_number": 12, "description": "...", "options": [...]}},
        {{"question_number": 13, "description": "...", "options": [...]}},
        {{"question_number": 14, "description": "...", "options": [...]}},
        {{"question_number": 15, "description": "...", "options": [...]}},
        {{"question_number": 16, "description": "...", "options": [...]}},
        {{"question_number": 17, "description": "...", "options": [...]}},
        {{"question_number": 18, "description": "...", "options": [...]}},
        {{"question_number": 19, "description": "...", "options": [...]}},
        {{"question_number": 20, "description": "...", "options": [...]}}
    ]
}}

IMPORTANT:
- Extract from BOTH images - do not stop at Q19
- Include ALL 10 questions (Q11-Q20)
- Return ONLY valid JSON with all 10 questions"""
